...
<div class="modal fade" id="Delete<?php echo $pemasukan->id ?>">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda Yakin Ingin Menghapus Data Pemasukan <b><?php echo  date("d/m/Y", strtotime($pemasukan->tanggal)); ?></b>?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Batal</button>
                <a href="<?php echo base_url('admin/pemasukan/delete/' . $pemasukan->id); ?>" class="btn btn-danger pull-right"><i class="fa fa-close"></i> Ya, Hapus Data</a>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
