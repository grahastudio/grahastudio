...
<div class="card shadow mb-4">
  <div class="col-md-8 mx-auto">
    ...
    <div class="card-body">
        ...
        <?php
        echo form_open_multipart('admin/download/update/'.$download->id);
        ?>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control" name="download_title" placeholder="Nama Vector" value="<?php echo $download->download_title; ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control" name="download_price" placeholder="Harga" value="<?php echo $download->download_price; ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control" name="download_url" placeholder="Url Download" value="<?php echo $download->download_url; ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-6">
                <div class="input-group mb-3">
                    ...
                    <img class="img-fluid" src="<?php echo base_url('assets/img/download/' .$download->download_image);?>">
                </div>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-9">
                ...
                <textarea class="form-control" id="summernote" name="download_desc"><?php echo $download->download_desc;?></textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control" name="download_keywords" placeholder="Pisahkan dengan koma" value="<?php echo $download->download_keywords; ?>">
            </div>
        </div>
